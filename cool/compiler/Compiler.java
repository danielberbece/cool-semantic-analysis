...
import cool.compiler.visitors.ASTConstructionVisitor;
import cool.compiler.visitors.DefinitionCheckVisitor;
import cool.compiler.visitors.HierarchyVisitor;
import cool.compiler.visitors.TypeCheckVisitor;
...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        CoolParserBaseVisitor<ASTNode> astConstructionVisitor = new ASTConstructionVisitor();

//        System.out.println(globalTree.toStringTree(parser));
        var ast = astConstructionVisitor.visit(globalTree);
        
        // Populate global scope.
        SymbolTable.defineBasicClasses();

        var definitionCheckVisitor = new DefinitionCheckVisitor();
        var hierarchyVisitor = new HierarchyVisitor();
        var typeCheckVisitor = new TypeCheckVisitor();

        ast.accept(definitionCheckVisitor);
        SymbolTable.establishHierarchy();
